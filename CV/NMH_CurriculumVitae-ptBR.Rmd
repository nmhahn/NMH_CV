...
aboutme: "Eu sou um estudante do bacharelado em Estatística e atuo na área de dados aplicando meus conhecimentos. Devido a isso, procuro sempre aprimorar minhas hard skills (estatística, machine learning, modelagem) e soft skills (comunicação, resiliência, autogestão), com o intuito de me desenvolver. Estou construindo minha carreira no núcleo de análise e ciência de dados."
headcolor: 126aa1
output: 
  vitae::awesomecv:
    keep_tex: false
