...
experiencia = tribble(
  ...
  "Business Intelligence Analyst (Sales Ops)", "January", 2022, "", "moment", "Aegro", "Creating Reports and Dashboards with Power BI and R",
  "Business Intelligence Analyst (Sales Ops)", "January", 2022, "", "moment", "Aegro", "Helped develop the Sales Department Structure in Power BI",
  "Business Intelligence Analyst (Sales Ops)", "January", 2022, "", "moment", "Aegro", "Automatizations with Power Automate (report update, sending emails)",
  "Business Intelligence Analyst (Sales Ops)", "January", 2022, "", "moment", "Aegro", "Ensuring Data Reliability",
  "Business Intelligence Analyst (Sales Ops)", "January", 2022, "", "moment", "Aegro", "Sales Operation KPI's Monitoring",
  "Business Intelligence Analyst (Sales Ops)", "January", 2022, "", "moment", "Aegro", "Presentation and Documentation of the Material Produced (reports, analysis)",
...
cursos = tribble(
  ...
  "Escola Superior de Propaganda e Marketing - ESPM (On-site)", "Business Analytics: Análise de Dados para Tomada de Decisão", "February", 2020, NA,
  "Universidade Federal do Rio Grande do Sul - UFRGS (On-site)", "Excel para Iniciantes", "July", 2018, NA
)
...
eventos = tribble(
  ...
  "Pontifícia Universidade Católica do Rio Grande do Sul - PUCRS (On-site)", "Feira de Ciências e Inovação do Museu de Ciências e Tecnologia da PUCRS", "October", 2016, NA,
  "Universidade Federal do Rio Grande do Sul - UFRGS (On-site)", "XI Salão UFRGS Jovem", "September", 2016, NA
)
