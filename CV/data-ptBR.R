...
experiencia = tribble(
  ...
  "Cientista de Dados"                     , "Janeiro"  , 2023, ""         , "momento", "Sicredi"                                          , "Processamento de Linguagem Natural (NLP) aplicada a Notícias para Obtenção de Insights",
  "Cientista de Dados"                     , "Janeiro"  , 2023, ""         , "momento", "Sicredi"                                          , "Automação de Processos para Cálculos de KPI's",
  "Cientista de Dados"                     , "Janeiro"  , 2023, ""         , "momento", "Sicredi"                                          , "Acompanhamento dos KPI's da Diretoria Executiva de Crédito",
  "Analista de BI (Sales Ops)"             , "Janeiro"  , 2022, "Janeiro"  , "2023"   , "Aegro"                                            , "Estruturação das Tabelas/Views consumidas pelo time de Vendas (resultados e metas da operação)",
  "Analista de BI (Sales Ops)"             , "Janeiro"  , 2022, "Janeiro"  , "2023"   , "Aegro"                                            , "Desenvolvimento da Estrutura do Departamento de Vendas no Power BI",
  "Analista de BI (Sales Ops)"             , "Janeiro"  , 2022, "Janeiro"  , "2023"   , "Aegro"                                            , "Automatizações com Power Automate (atualizações de relatórios, envios de e-mail)",
  "Analista de BI (Sales Ops)"             , "Janeiro"  , 2022, "Janeiro"  , "2023"   , "Aegro"                                            , "Criação de Relatórios e Dashboards",
  "Analista de BI (Sales Ops)"             , "Janeiro"  , 2022, "Janeiro"  , "2023"   , "Aegro"                                            , "Garantir a Confiabilidade dos Dados",
  "Analista de BI (Sales Ops)"             , "Janeiro"  , 2022, "Janeiro"  , "2023"   , "Aegro"                                            , "Monitoramento de KPI's da Operação de Vendas",
  "Analista de BI (Sales Ops)"             , "Janeiro"  , 2022, "Janeiro"  , "2023"   , "Aegro"                                            , "Apresentação e Documentação do Material Produzido",
...
eventos = tribble(
  ...
  "Universidade Federal da Bahia - UFBA (Online)"                             , "4ª Conferência em Estatística e em Ciência de Dados"                    , "Dezembro" , 2022, NA,
